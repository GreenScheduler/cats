...
`Hack Day <CW23HackDaypage_>`_ in Manchester where a team of ten of us (Colin Sauze,
...
intense day working to build a scheduler climate aware scheduler
...
By the end of that day we had a working version of CATS that could
